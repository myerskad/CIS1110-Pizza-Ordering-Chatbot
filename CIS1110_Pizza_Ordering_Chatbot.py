print("Hello, my name is Alex your vitual assistant. I will help you order a pizza!")
...
if userName.lower() == "kadence myers":
...
while keepGoing.lower() == "y":
    ...
    print(f"Your  {quantity} {size} {flavor} pizza(s) with  {crustType} costs ${total:,.2f}.")
    ...
    print("Order has been received. ETA is 3 mins!")
